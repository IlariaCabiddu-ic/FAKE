...
dataframe = [
            ...
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:01'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:02'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:03'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:04'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:05'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:06'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:07'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:08'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:09'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:10'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:11'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:12'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:13'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:14'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:15'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:16'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:17'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:18'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:19'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:20'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:21'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:22'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:23'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:24'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:25'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:26'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:27'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:28'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:29'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:30'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:31'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:32'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:33'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:34'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:35'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:36'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:37'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:38'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:39'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:40'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2017-12-23 00:00:41'),
            ...
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2018-12-23 00:00:41'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2018-12-23 00:00:42'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2018-12-23 00:00:43'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2018-12-23 00:00:44'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2018-12-23 00:00:45'),
            ('T1102', 'source1', 'Tech', -0.98, -0.98, '2018-12-23 00:00:46'),
...
for s in sources:
    E = []
    G = []
    Gwr = []  # goodwill without relevance
    C = []
    T = []
    Twr = []  # trust without relevance
    ...
    for j in range(df.shape[0]+1):
        ...
        goodwillwr = model_trust.compute_goodwill_witohut_relevance(df=sub_df, topics=topics)
        # print("The goodwill of analysed source '", s, "' is: ", goodwillwr)
...
# axs[3, 0].plot(x, Twr, 'tab:grey')
# axs[3, 0].set_title('Trust')
# axs[3, 0].set_ylim([0,1])
# axs[3, 0].set_yticks(np.arange(0, 1, step=0.1))
#
# axs[3, 1].plot(x, T, 'tab:red')
# axs[3, 1].plot(x, Twr, 'tab:grey')
# axs[3, 1].set_title('Trust (zoom)')

fig, axs = plt.subplots(1, 2, figsize=(10,4))
x = np.arange(1, len(E)+1)
# print(x)
axs[0].plot(x, G, 'tab:orange')
axs[0].plot(x, Gwr, 'tab:purple')
axs[0].set_title('Goodwill')
axs[0].set_ylim([0,1])
axs[0].set_yticks(np.arange(0, 1, step=0.1))

axs[1].plot(x, T, 'tab:red')
axs[1].plot(x, Twr, 'tab:green')
axs[1].set_title('Trust')
axs[1].set_ylim([0,1])
...
for ax in axs.flat:
    ...
    ax.legend(['With relevance', 'Without relevance'], loc='lower right')
plt.show()